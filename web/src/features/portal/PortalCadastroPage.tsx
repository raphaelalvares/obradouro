...
/** Cadastro do CLIENTE no portal — o arquiteto já autorizou o e-mail no projeto; aqui o cliente
 * escolhe a senha. É o signup comum do Supabase (com "Confirm email" ON: a confirmação prova a posse
      ...
      <div className="flex min-h-dvh flex-col justify-center px-6 py-12">
        <div className="animate-fade-up mx-auto w-full max-w-sm text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            ...
            Abra o e-mail para ativar seu acesso e entrar no portal.
          </p>
    ...
    <div className="flex min-h-dvh flex-col justify-center px-6 py-12">
      <div className="mx-auto w-full max-w-sm">
        <div className="animate-fade-in mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Crie seu acesso com o e-mail que seu arquiteto cadastrou.
          </p>
        </div>
